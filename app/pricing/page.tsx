...
export const metadata: Metadata = {
  ...
  description:
    "Three custom song packages — Starter, Professional, and Premium. Every project is quoted individually based on scope. Submit your idea for a fixed quote.",
  ...
  return (
    <>
        ...
        <div className="container-page relative py-20 text-center sm:py-24">
          <Reveal className="mx-auto max-w-2xl items-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-[#64748d]">
              ...
              idea, and I&rsquo;ll send you a clear, fixed quote.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <CTASection
        ...
        description="Submit your idea and I'll reply with a fixed quote and a plan — no obligation."
        secondaryLabel="Have a question first?"
